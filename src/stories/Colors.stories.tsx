...
function Swatch({ name, bg, fg, cssVar }: { name: string; bg: string; fg?: string; cssVar: string }) {
  return (
    <div className="flex flex-col gap-1">
      <div className={`h-16 w-full rounded-lg border ${bg} flex items-center justify-center`}>
        {fg && <span className={`text-xs font-medium ${fg}`}>Aa</span>}
      </div>
...
function ColorRow({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="space-y-3">
      <h3 className="text-sm font-semibold text-foreground border-b pb-2">{label}</h3>
  ...
  render: () => (
    <div className="space-y-8 max-w-4xl">
      ...
      <ColorRow label="Chart / Data Visualization">
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#6366f1" }}><span className="text-xs font-medium text-white">Indigo</span></div>
        ...
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#10b981" }}><span className="text-xs font-medium text-white">Emerald</span></div>
          <p className="text-xs font-semibold">#10b981</p>
          <p className="text-[10px] text-muted-foreground font-mono">Income, savings</p>
        </div>
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#f43f5e" }}><span className="text-xs font-medium text-white">Rose</span></div>
          <p className="text-xs font-semibold">#f43f5e</p>
          <p className="text-[10px] text-muted-foreground font-mono">Expenses, credit</p>
        </div>
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#8b5cf6" }}><span className="text-xs font-medium text-white">Violet</span></div>
        ...
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#06b6d4" }}><span className="text-xs font-medium text-white">Cyan</span></div>
          <p className="text-xs font-semibold">#06b6d4</p>
          <p className="text-[10px] text-muted-foreground font-mono">Transport, wallet</p>
        </div>
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#eab308" }}><span className="text-xs font-medium text-white">Yellow</span></div>
          <p className="text-xs font-semibold">#eab308</p>
          <p className="text-[10px] text-muted-foreground font-mono">Utilities, emergency</p>
        </div>
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#f97316" }}><span className="text-xs font-medium text-white">Orange</span></div>
          <p className="text-xs font-semibold">#f97316</p>
          <p className="text-[10px] text-muted-foreground font-mono">Shopping</p>
        </div>
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#ec4899" }}><span className="text-xs font-medium text-white">Pink</span></div>
          <p className="text-xs font-semibold">#ec4899</p>
          <p className="text-[10px] text-muted-foreground font-mono">Subscriptions</p>
        </div>
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#94a3b8" }}><span className="text-xs font-medium text-white">Slate</span></div>
      ...
      <ColorRow label="Account Type Colors">
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#6366f1" }}><span className="text-xs font-medium text-white">Checking</span></div>
          <p className="text-xs font-semibold">#6366f1</p>
        </div>
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#10b981" }}><span className="text-xs font-medium text-white">Savings</span></div>
          <p className="text-xs font-semibold">#10b981</p>
        </div>
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#f43f5e" }}><span className="text-xs font-medium text-white">Credit</span></div>
          <p className="text-xs font-semibold">#f43f5e</p>
        </div>
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#8b5cf6" }}><span className="text-xs font-medium text-white">Investment</span></div>
          <p className="text-xs font-semibold">#8b5cf6</p>
        </div>
        <div className="flex flex-col gap-1">
          <div className="h-16 w-full rounded-lg flex items-center justify-center" style={{ backgroundColor: "#06b6d4" }}><span className="text-xs font-medium text-white">Wallet</span></div>
          <p className="text-xs font-semibold">#06b6d4</p>
        </div>
      </ColorRow>
    </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 max-w-md">
          <div className="space-y-1">
            ...
            <div className="h-3 rounded-full bg-muted overflow-hidden"><div className="h-full rounded-full bg-emerald-500" style={{ width: "45%" }} /></div>
          </div>
          <div className="space-y-1">
            <div className="flex justify-between text-xs"><span>Near limit (70-100%)</span><span className="text-amber-600">85%</span></div>
            <div className="h-3 rounded-full bg-muted overflow-hidden"><div className="h-full rounded-full bg-amber-500" style={{ width: "85%" }} /></div>
          </div>
          <div className="space-y-1">
            <div className="flex justify-between text-xs"><span>Over budget (100%+)</span><span className="text-red-600">120%</span></div>
            <div className="h-3 rounded-full bg-muted overflow-hidden"><div className="h-full rounded-full bg-red-500" style={{ width: "100%" }} /></div>
          </div>
        </div>
      </div>
